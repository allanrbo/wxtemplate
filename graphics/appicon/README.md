Icon was drawn in Inkscape and exported manually in each resolution. Nothing seemed to beat the Inkscape renderer in terms of sharpness.
...
Run on Linux:
    ...
    convert icon_48x48.png icon.xpm
    sed -i 's/^static char /const static char/g' icon.xpm
